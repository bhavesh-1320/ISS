...
import editIconTimeZones from '@salesforce/resourceUrl/editIconTimeZone';
import trashTimeZone from '@salesforce/resourceUrl/trashTimeZone';
import joinTimeZone from '@salesforce/resourceUrl/joinTimeZone';
export default class Ifaire extends LightningElement {
  @api child ={};
  timedate ='';
  trashTimeZone = trashTimeZone;
  joinTimeZone = joinTimeZone;
  locationImage =searchHeading + '/ISSV2/location.png';

  editIcon = editIconTimeZones;
    timeZone = false;
    currentDate='';
    timeZoneArray =[
  {
...
this.timedate = utcStr.substring(0, 25);
console.log(utcStr); 

console.log(utcStr);
// console.log(date.getUTCHours().toString().padStart(2, '0'));
// console.log(
//   [
