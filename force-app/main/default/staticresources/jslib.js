...
!(function (e, t) {
    ...
    rerenderRows(e) {
      ...
      n.forEach((e) => {
        ...
        this.rows().length
          ...
          : (this.clear(), this.table.rowManager._showPlaceholder()),
      ...
      this.dispatchExternal('renderStarted'),
        ...
        this.displayRowsCount
          ? (this.renderer.renderRows(),
            this.firstRender &&
              ((this.firstRender = !1), this.layoutRefresh(!0)))
  ...
  class S extends k {
    ...
    initialize() {
      ;(this.langList = r.deepClone(S.langs)),
  ...
  var Z = {
    ...
    date: function (e, t, i, s, o) {
      ...
      function h(e) {
        return (r.isDateTime(e)
          ? e
          : 'iso' === n
          ? r.fromISO(String(e))
          : r.fromFormat(String(e), n)
        ).toFormat('yyyy-MM-dd')
      }
      if (
        ((l.type = 'date'),
      ...
      function d(e) {
        var t = l.value
        ;(null == a && '' !== t) || t !== a
          ? (t && n && (t = r.fromFormat(String(t), 'yyyy-MM-dd').toFormat(n)),
            i(t) && (a = l.value))
          : s()
      }
      return (
    ...
    time: function (e, t, i, s, o) {
      ...
      function d(e) {
        var t = h.value
        ;(null == l && '' !== t) || t !== l
          ? (t && r && (t = a.fromFormat(String(t), 'hh:mm').toFormat(r)),
            i(t) && (l = h.value))
          : s()
      }
      return (
    ...
    datetime: function (e, t, i, s, o) {
      ...
      function d(e) {
        var t = h.value
        ;(null == l && '' !== t) || t !== l
          ? (t && r && (t = a.fromISO(String(t)).toFormat(r)),
            i(t) && (l = h.value))
          : s()
      }
      return (
        ...
        r &&
          (a
            ? ((n = a.isDateTime(l)
                ...
                ? a.fromISO(String(l))
                : a.fromFormat(String(l), r)),
              (l = n.toFormat('yyyy-MM-dd') + 'T' + n.toFormat('hh:mm')))
            : console.error(
                "Editor Error - 'date' editor 'inputFormat' param is dependant on luxon.js",
              )),
        (h.value = l),
  ...
  class ie extends k {
    ...
    generateTableElement(e) {
      ...
      return (
        ...
        (r.groupHeader = this.table.options[
          'groupHeader' +
            (this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1))
        ]),
        r.groupHeader &&
    ...
    lookupTableStyles() {
      ...
      return (
        this.cloneTableStyle &&
          ...
          (e.firstGroup = this.table.element.getElementsByClassName(
            'tabulator-group',
          )[0]),
          e.firstRow &&
            ((e.styleCells = e.firstRow.getElementsByClassName(
              'tabulator-cell',
            )),
    ...
    generateHeaderFilterElement(e, t, i) {
      ...
      if (
        ...
        if (o) {
          ...
          d.langBind('headerFilters|columns|' + e.definition.field, function (
            e,
          ) {
            n.setAttribute(
              'placeholder',
